...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas de idioma a seguir são usadas para trocar o marcador do
    | atributo por algo mais amigável, como "Endereço de e-mail" em vez de
    | "email", deixando as mensagens mais expressivas.
    |
    */
